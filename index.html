...
<head>
	...
	<!-- Theme color -->
	<link id="switcher" href="assets/css/dark-blue-theme.css" rel="stylesheet">
					...
					<div class="mu-featured-area">
						...
						<div class="mu-featured-slider-wrapper">
							<div class="mu-featured-slider" id="typed-strings">
								<p>I am <span>Backend Developer</span></p>
								<p>I am <span>Web Developer</span></p>
								<p>I am <span>Software Engineer</span></p>
							</div>
							<span id="typed"></span>
						</div>
						<!-- Start text slide -->
	...
	<footer id="mu-footer" role="contentinfo">
		<div class="container">
			<div class="mu-footer-area">
				<p class="mu-copy-right">&copy; Copyright <a rel="nofollow" href="#"> 2022</a>. All right reserved.</p>
			</div>
		</div>
	</footer>
	<!-- End footer -->
